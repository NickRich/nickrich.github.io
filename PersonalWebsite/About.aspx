...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        I am currently employed at Compassion International as a Software Development Intern.
        I am working on our SalesForce platform team, the purpose of which is to connect sponsors to our beneficiaries in an efficient manner.
        My current tasks have included fixing account management issues, case assignment issues, and email distribution issues.
    </p>
    <p></p>
